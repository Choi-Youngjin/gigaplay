...
<header class="main_menu_sec navbar navbar-default navbar-fixed-top" style="height:100px;">
	...
	<div class="container">
					...
					<div class="main_menu">
                        ...
                        <div class="modal-wrapper">
                           <div class="modal">
                              ...
                              <div class="content">
                                 <font face="olleh" size="6" color="black"
                                    style="text-align: center">GiGA PLAY 회원가입</font>
                                 <form action="play/signup" method="post">
                                    <br>
                                    <p>
                                       <font face="맑은고딕" size="3" color="black">사번 *</font>
                                       <input id="signup-mid" type="text" name="mid"
                                          maxlength="10"
                                          style="color: black; width: 80%; float: right; height: 1.6em; margin-top: 3px; font-family: olleh;">
                                       <br> <span id="mid_errormsg_null" class="errormsg">사번을
                                          입력해주세요.</span> <span id="mid_errormsg_redun" class="errormsg">이미
                                          가입된 회원입니다.</span>
                                    </p>
                                    <p>
                                       <font face="맑은고딕" size="3" color="black">비밀번호 *</font>
                                       <!-- <font face="olleh" size="4" color="black">비밀번호 *</font> -->
                                       <input id="signup-pw" type="password" name="pw"
                                          maxlength="20"
                                          style="color: black; width: 80%; float: right; height: 1.6em; margin-top: 3px; font-family: olleh;">
                                    ...
                                    <p>
                                       <font face="맑은고딕" size="3" color="black">이름 *</font> <input
                                    ...
                                    <p>
                                       <font face="맑은고딕" size="3" color="black">생년월일</font> <input
                                    ...
                                    <p>
                                       <font face="맑은고딕" size="3" color="black">그룹 *</font> <select
                                          name="groups" id="signup-groups"
                                          style="color: red; width: 80%; float: right; height: 1.6em; margin-top: 3px ; font-family: olleh;">
                                    ...
                                    <p>
                                       <font face="맑은고딕" size="3" color="black">PHONE</font> <input
                                    ...
                                    <p>
                                       <font face="맑은고딕" size="3" color="black">EMAIL *</font> <input
                        ...
                        <div class="modal-wrapper-login">
                           <div class="modal">
                              ...
                              <div class="content">
                                 <font face="olleh" size="6" color="black"
                                    style="text-align: center">GiGA PLAY 로그인</font>
                                 <form name="login" method="post">
                                    <br>
                                    <p>
                                       <font face="맑은고딕" size="3" color="black">사번 *</font> <input
                                    ...
                                    <p>
                                       <font face="맑은고딕" size="3" color="black">비밀번호 *</font> <input
                        ...
                        <div class="modal-wrapper-tempplay">
                           <div class="modal">
                              ...
                              <div class="content">
                                 <font face="olleh" size="6" color="black"
                                    style="text-align: center">GiGA PLAY 번개 등록</font>
                                 <form name="tempplay" method="post">
                                    <br>
                                    <p>
                                       <font face="맑은고딕" size="3" color="black">PLAY명&nbsp;</font>
                                       <input id="play-temp-name" type="text" name="mid"
                                          style="color: black; width: 50%; display: inline; height: 1.6em; margin-top: 3px; font-family: olleh;">
                                       <br> <span id="tempplay_name_errormsg"
                                          class="errormsg">PLAY명을 입력해주세요.</span>
                                    </p>
                                    <p>
                                       <font face="맑은고딕" size="3" color="black">분야1&nbsp;&nbsp;</font>
                                       ...
                                       </select> <font face="맑은고딕" size="3" color="black">분야2&nbsp;&nbsp;</font>
                                       <input id="play-temp-category2" type="text" name="mid"
                                          style="color: black; width: 20%; display: inline; height: 1.6em; margin-top: 3px; font-family: olleh;">
                                    </p>
                                    <p>
                                       <font face="맑은고딕" size="3" color="black">가격&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>
                                       <input id="play-temp-price" type="text" name="mid"
                                          style="color: black; width: 10%; display: inline; height: 1.6em; margin-top: 3px; font-family: olleh;">
                                       <font face="맑은고딕" size="3" color="black">원</font> <font
                                          face="맑은고딕" size="3" color="black">&nbsp;&nbsp;/&nbsp;그룹&nbsp;&nbsp;</font>
                                       ...
                                       <font face="olleh" size="4" color="black">&nbsp;&nbsp;/&nbsp;사진 업로드&nbsp;&nbsp;</font>
												<input id="fileup" type="file"/>
                                    </p>
                                    <p>
                                       <font face="맑은고딕" size="3" color="black">설명</font>
                                       <textarea id="play-temp-intro" rows="6" cols="100"
                                          name="mid"
                                          style="color: black; font-family: olleh; display: inline; margin-top: 20px;">
                                      </textarea>
                                    </p>
                        ...
                        <div class="modal-wrapper-eduplay">
                           <div class="modal">
                              ...
                              <div class="content">
                                 <font face="olleh" size="6" color="black"
                                    style="text-align: center">GiGA PLAY 강좌 등록</font>
                                 <form name="eduplay" method="post">
                                    ...
                                    <p>
                                       ...
                                       <input id="play-edu-name" type="text" name="mid"
                                          style="color: black; width: 50%; display: inline; height: 1.6em; margin-top: 3px; font-family: olleh;">
                                       <br> <span id="eduplay_name_errormsg" class="errormsg">PLAY명을
                                          입력해주세요.</span>
                                    </p>
                                    <p>
                                       <font face="맑은고딕" size="3" color="black">분야1&nbsp;&nbsp;</font>
                                       <select name="category" id="play-edu-category1"
                                          style="color: red; font-family: olleh; width: 20%; display: inline; height: 1.6em; margin-top: 3px; margin-right: 10px;">
                                          <option value="sports">스포츠</option>
                                          <option value="art">문화/예술</option>
                                          <option value="food">요리/음식</option>
                                          <option value="volunteer">봉사/나눔</option>
                                          <option value="game">게임/레저</option>
                                       </select> <font face="olleh" size="3" color="black">분야2&nbsp;&nbsp;</font>
                                    ...
                                    <p>
                                       ...
                                       <textarea id="play-edu-intro" rows="6" cols="100"
                                          name="mid"
                                          style="color: black; display: inline; margin-top: 20px; font-family: olleh;">
                                      </textarea>
                                    </p>
                        ...
                        <div class="modal-wrapper-error-nologin">
                           <div class="modal">
                              ...
                              <div class="content">
                                 <font face="olleh" size="4" color="black">로그인을 해야 이용할 수 있습니다.</font>
                                 <br><br>
                        ...
                        <div class="modal-wrapper-newBoard">
                           <div class="modal">
                              ...
                              <div class="content">
                                 <font face="olleh" size="6" color="black"
                                    style="text-align: center">게시글 작성하기</font>
                                 <form action="newBoard" method="post">
                                    <br>
                                    <p>
                                       <font face="맑은고딕" size="3" color="black">말머리 *</font> <select
                                          name="category" id="newBoard-category"
                                          style="color: red; font-family: olleh; width: 80%; float: right; height: 1.6em; margin-top: 3px">
                                       ...
                                       <span id="board_category_errormsg_null" class="errormsg">말머리를
                                          선택해주세요.</span>
                                    </p>
                                    <p>
                                       <font face="맑은고딕" size="3" color="black">제목 *</font> <input
                                          id="newBoard-title" type="text" name="title"
                                          maxlength="10"
                                          style="color: black; width: 80%; float: right; height: 1.6em; margin-top: 3px; font-family: olleh;">
                                       <br>
                                       <!-- 에러메세지 출력 말머리를 선택해주세요 -->
                                       <span id="board_title_errormsg_null" class="errormsg">제목을
                                          입력해주세요.</span>
                                    </p>
                                    <p>
                                       <font face="맑은고딕" size="3" color="black">내용 *</font>
                                       <textarea name="content" id="newBoard-content"
                                          form="content" cols="40" rows="10" autofocus required
                                          wrap="hard" style="color: black; font-family: olleh; overflow: auto";> </textarea>
                                       <br>
                                       <!-- 에러메세지 내용을 작성해주세요 -->
                                       <span id="board_content_errormsg_null" class="errormsg">내용을
                                          작성해주세요.</span>
                                    </p>
                                    ...
                                    <input type="hidden" id="newBoard-cid" name="cid"
                                       value="${param.cid}" /> <input type="hidden"
                                       id="newBoard-member" name="member"
                        ...
                        <div class="modal-wrapper-clubSignup">
                           <div class="modal">
                              ...
                              <div class="content">
                                 <font face="olleh" size="6" color="black"
                                    style="text-align: center">동호회 가입</font>
		...
		<div id="bt-menu" class="bt-menu">
			<div id="bt-myinfo" class="bt-div" style="height: 0">
