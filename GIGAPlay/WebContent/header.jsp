											...
											<form action="play/signup" method="post">
												...
												<p>
													<font face="olleh" size="4" color="black">이름 *</font> <input
														...
														style="color: red; width: 80%; float: right; height: 1.6em; margin-top: 3px">
													<br>
													<span id="name_errormsg" class="errormsg">이름을
														입력해주세요.</span>
												</p>
												<p>
													<font face="olleh" size="4" color="black">생년월일</font> <input
														id="signup-birth" type="text" name="birth"
												...
												<p>
													<font face="olleh" size="4" color="black">EMAIL *</font> <input
														...
														style="color: red; width: 80%; float: right; height: 1.6em; margin-top: 3px">
													<br>
													<span id="email_errormsg" class="errormsg">이메일을
														입력해주세요.</span>
												</p>
												<br>
											...
											<form name="login" method="post">
												...
												<p>
													<font face="olleh" size="4" color="black">사번 *</font> <input
														...
														style="color: red; width: 80%; float: right; height: 1.6em; margin-top: 3px">
													<br>
													<span id="login_errormid" class="errormsg">사번을
												...
												<p>
													<font face="olleh" size="4" color="black">비밀번호 *</font> <input
														...
														style="color: red; width: 80%; float: right; height: 1.6em; margin-top: 3px">
													<br>
													<span id="login_errorpw" class="errormsg">비밀번호를
									...
									<div class="modal">
										...
										<div class="content">
											...
											<form name="tempplay" method="post">
												<br>
												<p>
													<font face="olleh" size="4" color="black">PLAY명</font> <input
														id="play-temp-name" type="text" name="mid"
														style="color: red; width: 80%; float: right; height: 1.6em; margin-top: 3px">
													<br>
													<span id="login_errormid" class="errormsg">사번을
														입력해주세요.</span> <span id="login_nomid" class="errormsg">존재하지
												...
												<p>
													<font face="olleh" size="4" color="black">분야</font> <input
														id="play-temp-category" type="password" name="mid"
														style="color: red; width: 80%; float: right; height: 1.6em; margin-top: 3px">
												</p>
												<p>
													<font face="olleh" size="4" color="black">설명</font>
													<textarea id="play-temp-intro" rows="6" cols="70"
														name="mid"
														style="color: red; width: 80%; float: right; margin-top: 20px; margin-bottom:5px;">
									        	</textarea>
												</p>
												<br>
												<p style="width: 70px; margin: 0 auto;">
